...
`sample_one_object_scene_matrix.py` may select generic, curated-asset, and
billiards scenes. Stage the selected records, render each branch, then collect
them with the staged outer manifest:
