...
try:
    from generate_marble_run_candidate import (
    ...
    from tools.generate_marble_run_candidate import (
        build_metadata as build_candidate_metadata,
        materialize_collision_meshes,
        simulate_marble_run_physics,
        validate_config as validate_candidate_config,
    )
    from tools.immutable_scene_contract import freeze_metadata, write_simulation_record
...
RENDERER = Path("tools/render_marble_run_scene.py")
CANDIDATE_PHYSICS = Path("tools/generate_marble_run_candidate.py")
