...
import render_sketchfab_background_compositions as comp  # noqa: E402


PHYSWEEP_ROOT = Path(__file__).resolve().parent.parent
DEFAULT_SOURCE_MANIFEST = PHYSWEEP_ROOT / "assets/manifests/sketchfab_foreground_source_v1.json"
