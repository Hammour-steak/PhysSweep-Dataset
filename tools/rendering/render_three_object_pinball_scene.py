#!/usr/bin/env python3
"""Explicit three-object passive pinball renderer over the shared sphere core."""
...
def render(metadata_path,video_path_override=None,frame_dir_override=None):
    return shared.render_specialized(metadata_path,video_path_override,frame_dir_override,
        object_count=3,schema_map={'physweep_passive_pinball_three_object_scene_v1':'passive_pinball'},renderer_path=Path(__file__).resolve(),
        sampler_path=CODE_ROOT/'tools/sampling/sample_three_object_pinball.py')
