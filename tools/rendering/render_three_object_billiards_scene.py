#!/usr/bin/env python3
"""Explicit three-object billiards renderer with source material slots."""
...
def render(metadata_path, video_path_override=None, frame_dir_override=None):
    return shared.render_specialized(metadata_path, video_path_override, frame_dir_override,
        object_count=3, schema_map={'physweep_billiards_three_object_scene_v1':'billiards'}, renderer_path=Path(__file__).resolve(),
        sampler_path=CODE_ROOT/'tools/sampling/sample_three_object_billiards.py')
