...
def main() -> None:
    ...
    extension_bindings = {
        ...
        "replacement_preparer": file_binding(
            root, "tools/release/prepare_specialized_release_replacements.py"
        ),
        "release_publisher": file_binding(root, Path(__file__)),
        "extension_contract": file_binding(
            root, "tools/release/specialized_release_extension.py"
        ),
        ...
        "render_evidence": file_binding(
            root, "tools/rendering/specialized_render_evidence.py"
        ),
